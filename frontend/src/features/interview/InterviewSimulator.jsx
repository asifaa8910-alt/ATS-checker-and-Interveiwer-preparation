        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="p-6 border rounded-2xl bg-card shadow-sm space-y-6 relative overflow-hidden">
              ...
              {/* Question card */}
              <div className="p-5 bg-muted/40 rounded-2xl border border-border flex items-start gap-4 animate-fadeIn">
                ...
                <div className="border rounded-2xl bg-card p-5 space-y-6 shadow-sm max-h-[85vh] overflow-y-auto pr-1 animate-fadeIn">
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    {[
                      ...
                      <div key={idx} className="p-2.5 bg-muted/40 border border-border rounded-xl text-center space-y-1">
                        <span className="text-[10px] text-muted-foreground font-bold uppercase">{metric.label}</span>
                        <h4 className="text-lg font-black text-foreground">{metric.val}%</h4>
                      </div>
                    ))}
                  </div>
                    ...
                    <div className="space-y-1.5">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {feedbackItem.missingConcepts?.map((c, idx) => (
                          <span key={idx} className="px-2 py-0.5 bg-muted border border-border rounded text-[10px] font-semibold text-foreground/85">
                            {c}
                          </span>
                        ))}
                      </div>
                  ...
                  <div className="space-y-1.5 border-t pt-3">
                    ...
                    <p className="text-xs leading-relaxed p-3 bg-muted/30 rounded-xl border border-border text-foreground/90">
